...
use App\Http\Controllers\Admin\ServiceAutoRenewalAdminToggleController;
use App\Http\Controllers\Admin\ServiceAutoRenewalAttemptResetController;
use App\Http\Controllers\Admin\ServiceAutoRenewalAttemptRetryController;
use App\Http\Controllers\Admin\ServiceAutoRenewalBulkActionController;
...
Route::middleware('auth')->group(function (): void {
    ...
    Route::middleware('permission:admin.access')->prefix('admin')->name('admin.')->group(function (): void {
        ...
        Route::get('/users/create', [AdminUserController::class, 'create'])->middleware(['permission:users.view', 'permission:users.manage'])->name('users.create');
        Route::post('/users', [AdminUserController::class, 'store'])->middleware(['permission:users.view', 'permission:users.manage'])->name('users.store');
        ...
        Route::get('/roles/{role}/edit', [RoleController::class, 'edit'])->middleware(['permission:users.view', 'permission:roles.manage'])->name('roles.edit');
        Route::put('/roles/{role}', [RoleController::class, 'update'])->middleware(['permission:users.view', 'permission:roles.manage'])->name('roles.update');
